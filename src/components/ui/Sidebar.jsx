...
export default function Sidebar() {
  return (
    <div className="absolute bottom-0 flex w-full h-14 justify-between items-center pr-2 bg-blue-800 sm:flex-col sm:w-14 sm:h-full sm:py-2 sm:px-0 sm:static z-10">
